    ...
    return (
            ...
            <div className="main-sidebar-header">
                <a href="index.html" className="header-logo">
                    ...
                    <img src="/backend/assets/images/brand-logos/desktop-dark.png" alt="logo" className="desktop-dark"/>
                    <img src="/backend/assets/images/brand-logos/toggle-dark.png" alt="logo" className="toggle-dark"/>
